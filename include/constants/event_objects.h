...
#define PLAYER_AVATAR_GFX_MALE_NORMAL     (IS_FRLG ? OBJ_EVENT_GFX_RED_NORMAL     : OBJ_EVENT_GFX_SPECIES(LARVESTA))
...
#define PLAYER_AVATAR_GFX_MALE_SURFING    (IS_FRLG ? OBJ_EVENT_GFX_RED_SURF       : OBJ_EVENT_GFX_SPECIES(LARVESTA))
...
#define PLAYER_AVATAR_GFX_FEMALE_NORMAL     (IS_FRLG ? OBJ_EVENT_GFX_GREEN_NORMAL     : OBJ_EVENT_GFX_SPECIES_SHINY(LARVESTA))
...
#define PLAYER_AVATAR_GFX_FEMALE_SURFING    (IS_FRLG ? OBJ_EVENT_GFX_GREEN_SURF       : OBJ_EVENT_GFX_SPECIES_SHINY(LARVESTA))
...
#define OBJ_EVENT_PAL_TAG_SURF_BLOB                 0x1134
...
#define OBJ_EVENT_PAL_TAG_ARCHEOPS_SURF_BLOB      0x8005
