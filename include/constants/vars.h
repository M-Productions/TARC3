...
#define VAR_INTRO_BOAT_CUTSCENE                                0x404E // Unused Var
...
#define VAR_BEACH_CHARACTERS_MET                        0x4083 // Unused Var
...
#define VAR_LOCALID_CUTSCENE_MAIN                                0x408B // Unused Var
#define VAR_LITTLEROOT_HOUSES_STATE_BRENDAN              0x408C
#define VAR_LITTLEROOT_RIVAL_STATE                       0x408D
#define VAR_BOARD_BRINEY_BOAT_STATE                      0x408E
#define VAR_DEVON_CORP_3F_STATE                          0x408F
#define VAR_BRINEY_HOUSE_STATE                           0x4090
#define VAR_LOCALID_CUTSCENE_SECOND                                0x4091 // Unused Var
...
#define VAR_ENCOUNTER_MON                                0x409B // Unused Var
...
#define VAR_MARSH_COMPLETE                                0x40DB // Unused Var
#define VAR_DESERT_COMPLETE                            0x40DC // Unused Var
...
#define VAR_MOUNTAIN_COMPLETE                                0x40E5 // Unused Var
...
#define VAR_GAME_STATE                                   0x40F7 // Unused Var
...
enum GameStates
{
    ...
    GS_NO_GENERATORS,
    GS_ONE_GENERATOR,
    GS_ONE_GENERATOR_CUTSCENE,
    GS_POST_ONE_GENERATOR,
    GS_TWO_GENERATORS,
    GS_TWO_GENERATORS_CUTSCENE,
    GS_POST_TWO_GENERATORS,
    GS_THREE_GENERATORS,
    GS_THREE_GENERATORS_CUTSCENE,
    GS_POST_THREE_GENERATORS,
    GS_TYRANTRUM_DEFEATED,
    GS_ENTERING_LAB,
    GS_AFTER_DRAMPA,
    GS_ROLL_CREDITS
};
