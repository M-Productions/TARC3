...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNFLEDFROMBATTLE]                   = COMPOUND_STRING("Anorith got scared!"),
    ...
    [STRINGID_NOFRIENDS]                            = COMPOUND_STRING("Your friends can't help right now!\p"),
    ...
    [STRINGID_PKMNLOSTFOCUS]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} lost its place in the song!"),
...
const u8 gText_BattleMenu[] = _("Fight{CLEAR_TO 56}Items\nFriends{CLEAR_TO 56}Run");
