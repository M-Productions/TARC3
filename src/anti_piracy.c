...
static const u8 sText_AntiPiracy[] = _(
    "{SHADOW DYNAMIC_COLOR2}WORKING TITLE{SHADOW DYNAMIC_COLOR1} is a {SHADOW DYNAMIC_COLOR5}free{SHADOW DYNAMIC_COLOR1}, "
    "fan-made {SHADOW DYNAMIC_COLOR6}ROM Hack{SHADOW DYNAMIC_COLOR1}.\n"
    "It should {SHADOW DYNAMIC_COLOR5}NEVER{SHADOW DYNAMIC_COLOR1} be {SHADOW DYNAMIC_COLOR5}sold{SHADOW DYNAMIC_COLOR1} or {SHADOW DYNAMIC_COLOR5}paid{SHADOW DYNAMIC_COLOR1} for.\n"
    "\n"
    "{PAUSE 60}"
    ...
    "\n"
    "{PAUSE 60}"
    "{SHADOW DYNAMIC_COLOR6}But mostly by Nico...{SHADOW DYNAMIC_COLOR1}\n"
    "\n"
    "{PAUSE 60}"
